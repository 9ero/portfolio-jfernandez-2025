...
export const profile: Profile = {
  ...
  about: {
    en: "Systems and infrastructure generalist with full stack development and AI integration — a platform/DevOps profile that also builds applications. Over two years as the primary technical owner of a company's systems: AWS infrastructure, the rescue of a business-critical legacy system, and AI features built for production, with cost control, failure handling and data privacy. Technical Lead since June 2026. Based in northern Costa Rica, available for hybrid work.",
    es: "Generalista de sistemas e infraestructura con desarrollo full stack e integración de IA — un perfil de platform/DevOps que además construye aplicaciones. Más de dos años como principal responsable técnico de los sistemas de una empresa: infraestructura en AWS, el rescate de un sistema legacy crítico y funciones de IA para producción, con control de costos, manejo de fallos y privacidad de datos. Líder Técnico desde junio de 2026. En la zona norte de Costa Rica, con modalidad de trabajo híbrida.",
  },
  location: {
